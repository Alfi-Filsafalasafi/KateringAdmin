...
<div class="box box-primary">
	<div class="box-header with-border">
		<h3 class="box-title">Edit Menu Catering</h3>
	</div>
	<!-- /.box-header -->
	<!-- form start -->
	<form class="form-horizontal" action="{{route('update_catering', ['id_menu' => $data->id_menu])}}" method="POST" enctype="multipart/form-data">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					@else
					<a href="{{asset('ximgnasboxyz/xmenu/catering/'. $data->foto_menu)}}">
						<img class="img-thumbnail" width="100" height="100" src="{{asset('ximgnasboxyz/xmenu/catering/'. $data->foto_menu)}}" alt="">
					</a>
					@endif
				</div>
			</div>
			...
			<a href="{{route('menu_catering')}}" type="button" class="btn btn-default pull-left">Cancel</a>
