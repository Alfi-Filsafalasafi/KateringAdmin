...
<div class="box box-primary">
	...
	<!-- /.box-header -->
	<!-- form start -->
	<form class="form-horizontal" action="{{route('aksi_kirim', ['kode_transaksi' => $data->kode_transaksi])}}" method="POST" enctype="multipart/form-data" >
		...
		<div class="box-body">
            ...
            <a href="{{route('terima_kirim',['kode_transaksi' =>$data->kode_transaksi])}}" type="button" class="btn btn-blue  " style="background-color:blue; color:white; " >Terima Pesanan</a>
			<a href="{{route('batal_kirim',['kode_transaksi' =>$data->kode_transaksi])}}" type="button" class="btn btn-danger  ">Batalkan Pesanan</a>
			<a href="{{route('list_pengiriman')}}" type="button" class="btn btn-default  ">Cancel</a>
