...
<div class="box box-primary">
	<div class="box-header with-border">
		<h3 class="box-title">Edit Menu Grocery</h3>
	</div>
	<!-- /.box-header -->
	<!-- form start -->
	<form class="form-horizontal" action="{{route('update_grocery', ['id_menu' => $data->id_menu])}}" method="POST" enctype="multipart/form-data">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					@else
					<a href="{{asset('ximgnasboxyz/xmenu/grocery/'. $data->foto_menu)}}">
						<img class="img-thumbnail" width="100" height="100" src="{{asset('ximgnasboxyz/xmenu/grocery/'. $data->foto_menu)}}" alt="">
					</a>
					@endif
				</div>
			</div>
                                    ...
                                    <select name="id_mitra" id="" class="form-control">
                                        @foreach($mitra as $mitras )
                                            <option 
                                                ...
                                                @if ($mitras->id_mitras === $data->id_mitras)
                                                    selected
                                                @endif
                                                > 
                                                {{ $mitras->nama_mitra}}
			...
			<a href="{{route('menu_grocery')}}" type="button" class="btn btn-default pull-left">Cancel</a>
