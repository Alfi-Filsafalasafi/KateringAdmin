...
<!-- navigation -->
@section('tambah_makanan_grocery','active')
<!-- title -->
@section('title','Menu Grocery')
<!-- content -->
@section('content')
<!-- /.row -->
<div class="row">
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<div class="box-tools">
						<form method="GET" action="{{route('menu_grocery')}}">
				...
				<table class="table text-center table-bordered table-hover">
					...
					<tr>
						...
						<td>
							...
							@else
								<a href="{{asset('ximgnasboxyz/xmenu/grocery/'. $menu->foto_menu)}}">
									<img class="img-thumbnail" width="100" height="100" src="{{asset('ximgnasboxyz/xmenu/grocery/'. $menu->foto_menu)}}" alt="">
								</a>
							@endif
						</td>
						...
						<td>
							<a href="{{route('edit_grocery_menu', ['id_menu' => $menu->id_menu])}}" class="btn btn-block btn-info btn-xs">edit</a>
                            <a href="{{route('hapus_grocery_menu', ['id_menu' => $menu->id_menu])}}" class="btn btn-block btn-danger btn-xs">Hapus</a>
						</td>
					</tr>
					@endforeach
				</table><br>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Menu Grocery</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" action="{{route('tambah_menu_grocery')}}" method="POST" enctype="multipart/form-data">
